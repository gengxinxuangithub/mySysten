  ...
  <div class="main">
    ...
    <div class="allTable">
      <el-table :data="tableData" height="79vh" border style="width: 100%" class="nowTable">
        ...
        <el-table-column prop="policeCode" label="组件编号" align="center"> </el-table-column>
        <el-table-column prop="name" label="组件名称" align="center"> </el-table-column>
        <el-table-column prop="phone" label="组件描述" align="center" width="350"> </el-table-column>
    ...
    <el-dialog :title="`${title}组件`" :visible.sync="dialogVisible" width="34%">
      <div>
        <el-form ref="form" :model="form" :rules="rules" label-width="80px" :disabled="title === '查看'">
          <el-row>
            <el-col :span="24">
              <el-form-item label="组件编号" prop="policeCode">
            ...
            <el-col :span="24">
              <el-form-item label="组件描述" prop="orgName">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        policeCode: [{ required: true, message: '组件编号不能为空', trigger: 'blur' }],
