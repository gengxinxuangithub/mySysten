<template>
  <div class="main">
    <el-row class="search">
      ...
      <el-col :span="4">
        <el-input v-model="applicationName" clearable @clear="search">
    ...
    <div class="allTable">
      <el-table :data="tableData" height="79vh" border style="width: 100%" class="nowTable">
        ...
        <el-table-column prop="roleNo" label="应用名称" align="center"> </el-table-column>
        <el-table-column prop="name" label="应用地址" align="center"> </el-table-column>
        <el-table-column prop="roleDesc" label="配置类型" align="center"> </el-table-column>
        <el-table-column prop="status" label="返回码" align="center"> </el-table-column>
        <el-table-column prop="status" label="状态" align="center"> </el-table-column>
        <el-table-column prop="updateTime" label="更新时间" align="center"> </el-table-column>
        <el-table-column label="操作" width="200" align="center">
          <template slot-scope="scope">
            <span class="look">查看</span>
            <span class="edit">配置</span>
    ...
    <el-dialog :title="`${title}应用配置`" width="28%" :visible.sync="dialogVisible">
      <div>
